...
import { ProposalCreatedEvent, VoteCastEvent } from '../typechain-types/contracts/ReBuild3Governor';

const { toUtf8Bytes, keccak256, parseEther } = ethers.utils;

describe('ReBuild3Governor', function () {
  ...
  describe('after proposing', () => {
    async function afterProposingFixture() {
      ...
      const { proposalId } = (event as ProposalCreatedEvent).args;
